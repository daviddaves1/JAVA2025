...
public class PessoaTest {
    ...
    public void testIdosoFaixa1() {
        ...
        System.out.println("Passou Teste Idosos - faixa 1");
    }
    ...
    public void testIdosoFaixa2() {
        ...
        p = new Pessoa("joão",2000.00,2,70);
        assertEquals(0,p.calculaImposto(),0);

        System.out.println("Passou Teste Idosos - faixa 2");
    }
    ...
    public void testIdosoFaixa3() {
        ...
        p = new Pessoa("paulo",3500.00,2,70);
        assertEquals(0,p.calculaImposto(),0);

        System.out.println("Passou Teste Idosos - faixa 3");
    }
    ...
    public void testIdosoFaixa4() {
        ...
        p = new Pessoa("paulo",4400.00,2,70);
        assertEquals(0,p.calculaImposto(),0);

        System.out.println("Passou Teste Idosos - faixa 4");
    }
    ...
    public void testIdosoFaixa5() {
        ...
        System.out.println("Passou Teste Idosos - faixa 5");
    }
